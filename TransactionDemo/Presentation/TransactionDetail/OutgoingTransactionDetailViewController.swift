//
//  OutgoingTransactionDetailViewController.swift
//  TransactionDemo
//
...
class OutgoingTransactionDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        icon.text = String.fontAwesomeIcon(name: .arrowCircleLeft)
